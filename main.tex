...
\thesistitle{Control Systems Engineering in\\Autonomous Underwater Vehicles} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
